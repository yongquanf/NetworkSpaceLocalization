...
public class CoordinateLogServer {
	private static final Log log = new Log(CoordinateLogServer.class);
	...
	private static CoordinateLogServer logServer = null;
	...
	public static void main(String[] args) {
		...
		logServer = new CoordinateLogServer();
	...
	class ReportCoordMsgHandler extends ObjCommCB<ReportCoordReqMsg> {
		...
		protected void cb(CBResult result, ReportCoordReqMsg reqMsg,
			...
			case OK: {
				...
				CoordinateLogServer.this.comm.sendResponseMessage(replyMsg,
