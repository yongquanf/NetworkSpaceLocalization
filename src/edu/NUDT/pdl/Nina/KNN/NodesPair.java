...
public class NodesPair<T> implements Serializable {
	...
	public NodesPair(T _startNode, T _endNode, double _rtt, T _fatherNode, double _elapsedTime,
			int _elapsedSearchHops) {
		startNode = _startNode;
		endNode = _endNode;
		fatherNode = _fatherNode;
		rtt = _rtt;
	...
	public boolean equals(Object obj) {
		...
		if (this.startNode != null && this.endNode != null) {
			if (this.startNode.equals(tmp.startNode) && this.endNode.equals(tmp.endNode)) {
				return true;
			}
	...
	public String SimtoString() {
		final StringBuffer sbuf = new StringBuffer(1024);
		/*
		 * sbuf.append("("); sbuf.append(startNode.toString()); sbuf.append(": "
		 * ); sbuf.append(rtt); sbuf.append(")");
		 */
	...
	public static void main(String[] args) {
		NodesPair m = new NodesPair(AddressFactory.createUnresolved("192.168.1.45", 56),
				AddressFactory.createUnresolved("192.168.1.46", 58), -2);
		Vector<NodesPair> vec = new Vector<NodesPair>(1);
		vec.add(m);
		NodesPair m1 = new NodesPair(AddressFactory.createUnresolved("192.168.1.45", 56),
				AddressFactory.createUnresolved("192.168.1.46", 58), -2);
